//! Error vocabulary for append, truncate, and compaction mutations.
//!
//! Each enum separates a caller ordering or bounds mistake from an encoding
//! failure, an ambiguous I/O outcome, and a handle that now requires reopen.

use std::{error::Error, fmt};

use rafter::LogIndex;

use crate::{EncodeRaftLogEntryError, StorageIoError};
