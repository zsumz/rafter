...
//!
//! What these tests cover is the *behaviour* of the read paths, the encoder,
//! and both segments at the boundary. They do not enumerate the crate's decode
//! sites; see `src/format/log_position.rs` for why that enumeration is a review
