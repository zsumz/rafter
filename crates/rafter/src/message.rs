use crate::{
    ConfigurationEntry, LogEntryKind, LogIndex, NodeId, RaftSnapshotMetadata, SnapshotChunkRequest,
    SnapshotChunkSend, SnapshotChunkSource, SnapshotTransferId, Term,
};
...
impl LogEntry {
    ...
    #[must_use]
    pub fn application(term: Term, payload: Vec<u8>) -> Self {
        Self {
            term,
