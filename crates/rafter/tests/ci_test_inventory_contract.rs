...
fn filtered_ci_test_lanes_declare_exact_nonzero_inventories() {
    ...
    for selection in [
        ...
        "scripts/cargo-test-exact 62 execution::process:: --inventory verification/launcher-process-test-inventory.txt --locked -p rafter-invariants -- --test-threads=1",
        ...
        "scripts/cargo-test-exact 16 artifact_verify::simulator::event_semantics_tests --locked -p rafter-invariants -- --test-threads=1",
        "scripts/cargo-test-exact 8 artifact_verify::test_logs::tests --locked -p rafter-invariants -- --test-threads=1",
        "scripts/cargo-test-exact 61 artifact_verify:: --inventory verification/artifact-verifier-test-inventory.txt --locked -p rafter-invariants --lib -- --test-threads=1",
        ...
        "scripts/cargo-test-exact 61 maelstrom --inventory verification/maelstrom-test-inventory.txt --locked -p rafter-invariants",
    ] {
