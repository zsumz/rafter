...
//!
//! The fourth shape — the category projections — lives in [`super::kind`] and is
//! re-exported here, because those four enums are read by one audience and these
//! three by another.

use std::fmt;

pub use super::kind::{
    ReadErrorKind, ShutdownErrorKind, TransferLeadershipErrorKind, WriteErrorKind,
};
