...
| Sharded counter | Durable process composition and exact-archive process execution | `scripts/reference-process-check`; `scripts/reference-package-process-check`; CI/main `reference-process` and `reference-package-process` |
